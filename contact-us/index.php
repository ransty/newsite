<?php
	if (isset($_POST["submit"])) {
		...
		$from = 'From: (root) info@learnpassdrive.com.au' . "\r\n" .
    'Reply-To: (' . $name . ')' . $email . "\r\n" .
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="learnpassdrive contact form php angelo easy">
    <meta name="author" content="Keano Porcaro">
    <title>LearnPassDrive | Contact Form</title>

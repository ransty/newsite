...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="booking.html#booking">Booking</a>
                    </li>
                    <li>
    ...
    <div id="contact" style="width: 500px; margin: 0 auto; margin-left: auto; margin-right: auto;">
        ...
        <form name="gform" id="gform" action="magic" method="POST" action="contact.php" enctype="text/plain" onsubmit="submitted=true;">
            ...
            <input class="form-control" type="text" name="suburb" required placeholder="Suburb"><br>
            <label><h4 class="service-heading">Phone:</h4></label><br>
            <input class="form-control" type="text" name="phone" required placeholder="Phone Number"><br>
            ...
            <label><h4 class="service-heading">Query:</h4></label><br>
            <textarea class="form-control" required="" name="query" rows="9" maxlength="1000" style="height:183px;overflow-y:hidden;"></textarea>
            <br>
            <div class="col-lg-12 text-center" >
